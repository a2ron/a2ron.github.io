...
A basic HTTP Server to manage GPIO pins as output in a ESP6288 NodeMCU.

[Source](gpio-server.ino).

## NodeMCU schema

> Notice pin indexes regard to NodeMCU naming, which is different from GPIO-X indexes.

![](assets/NodeMCU_Pinout.png)
